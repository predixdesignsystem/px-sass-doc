...
function runBaseTests() {
  px_sass_doc_viewer_1 = document.getElementById('px_sass_doc_viewer_1');

  suite('Base Automation Tests for px-sass-doc-viewer', function() {

    test('Polymer exists', function() {
      assert.isTrue(Polymer !== null);
    });
    test('px-sass-doc-viewer fixture is created', function() {
      assert.isTrue(document.getElementById('px_sass_doc_viewer_1') !== null);
    });
